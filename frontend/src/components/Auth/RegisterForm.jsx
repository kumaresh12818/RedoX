...
export default function RegisterForm() {
  ...
  return (
    <div className="auth-page page-wrapper">
      <div className="auth-container glass-card animate-fade-in-up" id="register-form-container">
        <div className="auth-header">
          <h1 className="auth-title">Create Account</h1>
          <p className="auth-subtitle">Start analyzing your medical scans with AI</p>
        </div>
        ...
        <button className="btn btn-secondary btn-lg auth-google" onClick={handleGoogle} id="google-register-btn">
