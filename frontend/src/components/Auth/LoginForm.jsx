...
export default function LoginForm() {
  ...
  return (
    <div className="auth-page page-wrapper">
      <div className="auth-container glass-card animate-fade-in-up" id="login-form-container">
        ...
        <button className="btn btn-secondary btn-lg auth-google" onClick={handleGoogle} id="google-login-btn">
